...
const Lists = () => {
    ...
    return (
        <div className='border rounded-md flex flex-col items-center justify-start w-[95%] md:w-[80%] sm:w-9/12 h-4/5 my-8 shadow-2xl bg-white'>

            <h1 className="my-4 text-3xl font-extrabold text-teal-600 dark:text-white md:text-5xl lg:text-6xl">My Lists</h1>

            <div className='flex flex-col border-lime-900 rounded-t-md items-center justify-center px-3 py-3 w-11/12 sm:w-4/5 mt-4 '>
                ...
                <div className="w-4/5 mt-4 flex items-center justify-end">
                    <input className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full md:w-1/2 py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white " id="inline-full-name" type="text" placeholder='Search for list' onChange={(e) => { setQuery(e.target.value) }} />
                </div>
